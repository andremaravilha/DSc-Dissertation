#ifndef MANEUVER_SCHEDULING_MIP_ARC_TIME_INDEXED_H
#define MANEUVER_SCHEDULING_MIP_ARC_TIME_INDEXED_H
...
namespace orcs {
     ...
     * on arc- and time-indexed variables for maneuver scheduling problem in the
     * restoration of electric power distribution networks.
     */
    class MIPArcTimeIndexed : public Algorithm {
    public:
